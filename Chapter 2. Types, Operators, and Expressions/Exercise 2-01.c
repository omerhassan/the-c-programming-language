...
/* Exerciese 2-1. Wite a program to detrmine the ranges of char, short, int,
   and long variables, both signed and unsigend, by printing a ppropriate  
   values from standard headers and by direct computation. Harder if you comp-
   ute them: detrmine the ranges of the various floating-point types. */
